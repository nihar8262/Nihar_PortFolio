  ...
  return (
    <div id="contact" >
      <div className="flex  flex-col justify-center items-center  ">
        {/* contact header */}
        <div className="text-white text-center mt-10  w-[24rem] mb-10 md:w-[34rem] ">
        ...
        <form
         ...
         method="POST"
         className="bg-[#171721] p-4 mt-10 w-[25rem]  rounded-lg shadow-lg shadow-blue-800/50 flex flex-col gap-5 mb-20">
          <div>
