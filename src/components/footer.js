  ...
  return (
    ...
    className="relative flex  flex-col justify-center items-center w-full mt-32">
      ...
      <div className="hover:bg-gradient-to-r from-black via-black/70 to-orange-400  transform transition duration-500 hover:scale-125 cursor-pointer border p-3 rounded-full">
        ...
        {/* <div className="hover:bg-gradient-to-r from-yellow-400 via-blue-700 to-red-600  transform transition duration-500 hover:scale-125 cursor-pointer border p-3 rounded-full">
