...
export const Mobilenav = ({ onClose }) => {
  ...
  return (
    <div className='flex flex-col w-[20rem] p-7 shadow-md shadow-black bg-black/70 backdrop-blur-xl rounded-3xl fixed text-3xl top-12 right-0 z-50 border border-white/20'>
